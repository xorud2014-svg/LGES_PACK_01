...
#define CAN_FD_A_CHIP2 //kjg_2020_0321
...
static unsigned int canFilterControlResetValue = 0x00000000;

//Filter and Mask Object Reset Values
#define N_CHIP_FILT_OBJ_REGS			(CHIP_FILT_TOTAL * _CHIP_FILTER_OFFSET)

static unsigned int canFilterObjectResetValues[] = {
...
#define RT_CAN_FD_SPI_TX_BD1_1			0x11 //kjg_2020_1212_s
#define RT_CAN_FD_SPI_TX_BD1_2			0x12
#define RT_CAN_FD_SPI_TX_BD1_3			0x13
#define RT_CAN_FD_SPI_TX_BD1_4			0x14
#define RT_CAN_FD_SPI_TX_BD1_5			0x15
#define RT_CAN_FD_SPI_TX_BD1_6			0x16
#define RT_CAN_FD_SPI_TX_BD1_7			0x17
#define RT_CAN_FD_SPI_TX_BD1_8			0x18
#define RT_CAN_FD_SPI_TX_BD1_9			0x19
#define RT_CAN_FD_SPI_TX_BD1_A			0x1A
#define RT_CAN_FD_SPI_TX_BD1_B			0x1B
#define RT_CAN_FD_SPI_TX_BD1_C			0x1C
#define RT_CAN_FD_SPI_RX_BD1_1			0x11
#define RT_CAN_FD_SPI_RX_BD1_2			0x12
#define RT_CAN_FD_SPI_RX_BD1_3			0x13
#define RT_CAN_FD_SPI_RX_BD1_4			0x14
#define RT_CAN_FD_SPI_RX_BD1_5			0x15
#define RT_CAN_FD_SPI_RX_BD1_6			0x16
#define RT_CAN_FD_SPI_RX_BD1_7			0x17
#define RT_CAN_FD_SPI_RX_BD1_8			0x18
#define RT_CAN_FD_SPI_RX_BD1_9			0x19
#define RT_CAN_FD_SPI_RX_BD1_A			0x1A
#define RT_CAN_FD_SPI_RX_BD1_B			0x1B
#define RT_CAN_FD_SPI_RX_BD1_C			0x1C
#define RT_CAN_FD_SPI_TX_BD2_1			0x21
#define RT_CAN_FD_SPI_TX_BD2_2			0x22
#define RT_CAN_FD_SPI_TX_BD2_3			0x23
#define RT_CAN_FD_SPI_TX_BD2_4			0x24
#define RT_CAN_FD_SPI_TX_BD2_5			0x25
#define RT_CAN_FD_SPI_TX_BD2_6			0x26
#define RT_CAN_FD_SPI_TX_BD2_7			0x27
#define RT_CAN_FD_SPI_TX_BD2_8			0x28
#define RT_CAN_FD_SPI_TX_BD2_9			0x29
#define RT_CAN_FD_SPI_TX_BD2_A			0x2A
#define RT_CAN_FD_SPI_TX_BD2_B			0x2B
#define RT_CAN_FD_SPI_TX_BD2_C			0x2C
#define RT_CAN_FD_SPI_RX_BD2_1			0x21
#define RT_CAN_FD_SPI_RX_BD2_2			0x22
#define RT_CAN_FD_SPI_RX_BD2_3			0x23
#define RT_CAN_FD_SPI_RX_BD2_4			0x24
#define RT_CAN_FD_SPI_RX_BD2_5			0x25
#define RT_CAN_FD_SPI_RX_BD2_6			0x26
#define RT_CAN_FD_SPI_RX_BD2_7			0x27
#define RT_CAN_FD_SPI_RX_BD2_8			0x28
#define RT_CAN_FD_SPI_RX_BD2_9			0x29
#define RT_CAN_FD_SPI_RX_BD2_A			0x2A
#define RT_CAN_FD_SPI_RX_BD2_B			0x2B
#define RT_CAN_FD_SPI_RX_BD2_C			0x2C //kjg_2020_1212_e
...
#define CHIP_SPI_BUFFER_LENGTH			96 //kjg_2020_0322
#define FPGA_SPI_BUFFER_LENGTH			104 //kjg_2020_0326 100->104
...
//kjg_181121 void *rt_can_task(void *); //kjg_180521
void tx_can_data(int); //kjg_180521
void tx_can_data_2(int); //kjg_181121
void tx_can_data_3(int);
...
unsigned int rt_can_fd_rx(void); //kjg_181121
void rt_can_fd_rx2(unsigned int); //kjg_181121
int rt_can_fd_rx3(unsigned int);
int rt_can_fd_rx4(unsigned int);

int CAN_FD_A_Initialize(int, int, int, int, int, int, int);
int CAN_FD_A_Initialize_3(int, int, int, int, int, int, int, int);

int rt_can_set_param(int, int, int, int, int, int, int, int);
int rt_can_set_param_2(int);
int rt_can_set_param_3(int);
...
char SPI_Transfer_3a(int, unsigned char *, unsigned char *, unsigned short, unsigned char, int);
char SPI_Transfer_3b(int, unsigned short);
char SPI_Transfer_4a(int, unsigned char *, unsigned char *, unsigned short, unsigned char, int);
char SPI_Transfer_4b(int, unsigned char *, unsigned short);
...
char CHIP_WriteByteArray_3(int, unsigned short, unsigned char *, unsigned short);
...
//kjg_2020_0322 char CHIP_ReadByteArrayWithCRC(int, unsigned short, unsigned char *, unsigned short);
char CHIP_ReadByteArrayWithCRC(int, unsigned short, unsigned char *, unsigned short, bool, bool *);
char CHIP_ReadByteArrayWithCRC_4(int, unsigned short, unsigned short, bool, bool *);
...
//kjg_2020_0322
char CHIP_LowPowerModeEnable(int);
char CHIP_LowPowerModeDisable(int);
...
char CHIP_TransmitChannelLoad_3a(int, T_CHIP_fifoChannel, bool, struct rt_can_fd_struct *, int);
char CHIP_TransmitChannelLoad_3b(int, T_CHIP_fifoChannel, bool);

//TX Queue Load
//Loads data into Transmit Queue
//Requests transmission, if flush==true
//static inline char CHIP_TransmitQueueLoad(int index, T_CHIP_txMsgObj *txObj, unsigned char *txd, unsigned int txdNumBytes, bool flush)
//{ //kjgw_2020_0322
//	return CHIP_TransmitChannelLoad(index, T_CHIP_TXQUEUE_CH0, flush, struct rt_can_fd_struct *, int);
//}
...
//kjgw_2020_0322
//static inline char CHIP_TransmitQueueFlush(int index)
//{
//	return CHIP_TransmitChannelFlush(index, T_CHIP_TXQUEUE_CH0);
//}

//kjgw_2020_0322
//static inline char CHIP_TransmitQueueReset(int index)
//{
//	return CHIP_TransmitChannelReset(index, T_CHIP_TXQUEUE_CH0);
//}

//kjgw_2020_0322
//static inline char CHIP_TransmitQueueUpdate(int index, bool flush)
//{
//	return CHIP_TransmitChannelUpdate(index, T_CHIP_TXQUEUE_CH0, flush);
//}
...
//kjgw_2020_0322
//static inline char CHIP_TransmitQueueAbort(int index)
//{
//	return CHIP_TransmitChannelAbort(index, T_CHIP_TXQUEUE_CH0);
//}
...
char CHIP_ReceiveMessageGet_4(int, T_CHIP_fifoChannel, T_CHIP_rxMsgObj *);
...
//kjg_2020_0322
//static inline char CHIP_TransmitQueueEventGet(int index, T_CHIP_TX_FIFO_EVENT *flags)
//{
//	return CHIP_TransmitChannelEventGet(index, T_CHIP_TXQUEUE_CH0, flags);
//}
...
//kjgw_2020_0322
//static inline char CHIP_TransmitQueueIndexGet(int index, unsigned char *idx)
//{
//	return CHIP_TransmitChannelIndexGet(index, T_CHIP_TXQUEUE_CH0, idx);
//}

//kjgw_2020_0322
//static inline char CHIP_TransmitQueueEnable(int index, T_CHIP_TX_FIFO_EVENT flags)
//{
//	return CHIP_TransmitChannelEventEnable(index, T_CHIP_TXQUEUE_CH0, flags);
//}

//kjgw_2020_0322
//static inline char CHIP_TransmitQueueDisable(int index, T_CHIP_TX_FIFO_EVENT flags)
//{
//	return CHIP_TransmitChannelEventDisable(index, T_CHIP_TXQUEUE_CH0, flags);
//}

//kjgw_2020_0322
//static inline char CHIP_TransmitQueueEventAttempClear(int index)
//	return CHIP_TransmitChannelEventAttemptClear(int, T_CHIP_TXQUEUE_CH0);
//}
...
char CHIP_RamInit_3(int, unsigned char, int);
...
char CHIP_OscillatorControlSet(int, T_CHIP_oscCtrl);
char CHIP_OscillatorControlObjectReset(T_CHIP_oscCtrl *);
...
//kjg_181121 void cleanup_module(void);
int init_rt_can(void); //kjg_181121
void cleanup_rt_can(void); //kjg_181121
