...
void	Analog_Value_Input_12(int);
void  	Get_AD_Value_12(int, int, int);
void 	Read_AD_Data_12(int, int, int);
void	AD_Data_Calculate_12(int, int, int);
void 	Set_Mux_12(int);
void	CalChAverage_12(int, int);
#endif
