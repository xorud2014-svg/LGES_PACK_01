...
int		I_In_FlagCheck_Gui_Shutdown(void);	//ktg_250410	//jhj_250410
...
int		I_In_FlagCheck_Chamber_6(void);	//jhkw_171015
int		I_In_FlagCheck_Chamber_7(int);	//csk_190527
int		I_In_FlagCheck_Chamber_8(void);	//ktg_230215
int		I_In_FlagCheck_Fan(void);
int		I_In_FlagCheck_BreakDown(void);	//ktg_240930
void	I_OutScan(void);
