...
int opentty(void)
{
	...
	switch(comm_param.bps) {
		case TMT_B3:	trm.c_cflag = B300;		break;
		case TMT_B6:	trm.c_cflag = B600;		break;
		case TMT_B12:	trm.c_cflag = B1200;	break;
		case TMT_B24:	trm.c_cflag = B2400;	break;
		case TMT_B48:	trm.c_cflag = B4800;	break;
		case TMT_B96:	trm.c_cflag = B9600;	break;
		case TMT_B192:	trm.c_cflag = B19200;	break;
		case TMT_B384:	trm.c_cflag = B38400;	break;
		case TMT_B576:	trm.c_cflag = B57600;	break;
		case TMT_B1152:	trm.c_cflag = B115200;	break;
	}

	switch(comm_param.type) {
		case 0:
			trm.c_cflag |= (CS8 | CREAD);
			break;
		case 1:
			trm.c_cflag |= (CS7 | CREAD | CSTOPB | PARENB);
			break;
		default:
			trm.c_cflag |= (CS8 | CREAD | PARENB);
			break;
	}
