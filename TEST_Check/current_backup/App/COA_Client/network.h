...
int		rcv_cmd_comm_check_2(void);	//jhkw_200508
...
int		rcv_cmd_th_table_set(void);	//jhkw_191108
int		rcv_cmd_eol_procedure_request(void);
int		rcv_cmd_bms_procedure_request(void);
int		rcv_cmd_calimode_request(void);
int		rcv_cmd_cali_stop(void);	//jhkw_200317
int		rcv_cmd_autocali_request(void);	//jhkw_200317
int		rcv_cmd_autocali_temp_request(void);	//jhkw_200317
...
void	send_save_data_2(int, int, int);	//jhkw_190830
...
void	send_cmd_cali_check_result(int, int);	//jhkw_200317
void	send_cmd_comm_check_reply(void);
void	send_cmd_comm_check_reply_2(void);	//jhkw_200508
...
void	send_cmd_daq_isolation_reply2(int, int);	//jhkw_150224
...
void	send_cmd_th_table_set_reply(int);	//jhkw_191108
void	send_cmd_autocali_temp_reply(int val);	//jhkw_200317
