...
long 	Calculate_Crate_Value(unsigned char, int); //jhkw_191108
//20181219 KHK------------------------------
//int		Read_SOC_Tracking_File(char *, int, int);
int		Read_SOC_Tracking_File(char *, int, int, unsigned char); //jhkw_201102
int		Read_Sequence_Charge_File(char *, int, int);	//jhkw_221205
...
int		read_test_cond_pattern_file_coa(char *, int, int, unsigned char);
