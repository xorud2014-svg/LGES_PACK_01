...
typedef struct s_jig_misc_tag {
	...
	unsigned char		internal_input[4];
	unsigned char		internal_output[4];

	unsigned char		servo_motor_input[4];
	unsigned char		servo_motor_output[4];

	unsigned char		step_motor_input[4];
	unsigned char		step_motor_output[4];
} S_JIG_MISC;
