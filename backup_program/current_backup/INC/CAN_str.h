...
typedef struct s_can_config_tag {
	...
	//kjh_211021 unsigned char		reserved1[4];
	unsigned char		can_delay;	//sec	//kjh_211021
	unsigned char		reserved1[3];	//kjh_211021
...
typedef struct s_can_receive_normal_data_tag {
	...
	//unsigned char		reserved4[2];	//ktg_210706
	unsigned char		cell_check;		//ktg_210706
	unsigned char		reserved4;		//ktg_210706
...
typedef struct bms_uds_data_tag {
	short int			rx_message_count;
	short int			rx_dtc_count;
...
typedef struct s_can_cell_tag {	//ktg_210706s
	long				preCell;
	long				prepreCell;
	long				currentCell;	//ktg_220214
	long				svdfCell;
	long				can_svdfcount;
	long		 		DropmaxCell;
	long				DropminCell;
	long				preCell_100ms;		//ktg_230728
	long				currentCell_100ms;	//ktg_230728
	long				diffCell_100ms;		//ktg_230728
	unsigned char		DropCellcount;
	//unsigned char		CanFreezecount;	//ktg_230728
	unsigned short int	CanFreezecount;	//ktg_230728	//ktg_231113
	//unsigned char		reserved1[3];
	unsigned char		reserved1[2];
	long				gasCell[2];		//ktg_220331
	long				diffGasCell;
	unsigned char		gasSoftVentCanCount;
	unsigned char		gasHardVentCanCount;
	short int			reserved2;
} S_CAN_CELL;	//ktg_210706e

typedef struct s_can_tag {
	S_CAN_CONFIG		config;

	unsigned char		rt_can_ch_phase; 						//csk_240301_s
	unsigned char		rt_can_control_phase[MAX_CAN_PORT];
	long long			chip_diff_1tick_count[MAX_CAN_PORT]; 	//csk_240301_e
	...
	short int			uds_rx_message_count;
	short int			uds_rx_dtc_count;
	long				reserved1[4];

	long				can_timer_1sec[MAX_CAN_PORT]; //kjhw_170303
	long				can_timer_1min[MAX_CAN_PORT]; //kjhw_170303
