...
//csk_170908s
void	COM_Signal_Check_KEYSIGHT_34461A(int);
int		CmdHeader_Check_KEYSIGHT_34461A(int);
int		rcv_cmd_answer_KEYSIGHT_34461A(int);
void	send_cmd_initialize_KEYSIGHT_34461A(int, int);
void	send_cmd_request_KEYSIGHT_34461A(int);
//csk_170908e
