...
typedef struct s_digital_io_config_tag {
	...
	long				fan_err_detect_time;	//phb_221223 //shh_230607
} S_DIO_CONFIG;
...
typedef struct s_digital_io_misc_tag {
	...
	long				fan_err_time;	//phb_221223 //shh_230607
	long				fan_scan_time;	//phb_221223 //shh_230607	
} S_DIO_MISC;
...
typedef struct s_digital_in_out_tag {
	...
	unsigned char		signal[MAX_DIO_SIGNAL];	//phb_230710
