...
void	Copy_Th_Table(int);	//jhkw_181119
void	Copy_Humidity_Table(int);	//csk_200207
void	Copy_CAN_Th_Table(int);	//ktg_220614
...
int		Read_Humidity_Table(void);				//khj_191205
int		Read_Humidity_Table_Type(int, int);		//khj_191205

int		Read_CAN_Th_Table(void);				//ktg_220614
int		Read_CAN_Th_Table_Type(int, int);		//ktg_220614

int		Read_Measure_Cali_Temp(int);			//khj_210802
